...
begin
  ...
  else raise exception 'Found % active organizations. Set target_slug at the top of demo_seed_instagram_v3.sql.',v_org_count; end if;
  ...
  insert into public.employee_services (organization_id,employee_id,service_id) values
    ...
    (v_org_id,v_emp_luka,v_srv_brows),(v_org_id,v_emp_luka,v_srv_lashes),(v_org_id,v_emp_luka,v_srv_oxy),
    (v_org_id,v_emp_ivan,v_srv_laser),(v_org_id,v_emp_ivan,v_srv_body),(v_org_id,v_emp_ivan,v_srv_massage),
    (v_org_id,v_emp_petra,v_srv_pedi),(v_org_id,v_emp_petra,v_srv_mani),(v_org_id,v_emp_petra,v_srv_brows);
  ...
  insert into public.service_rooms (organization_id,service_id,room_id) values
    ...
    (v_org_id,v_srv_oxy,v_room_2),(v_org_id,v_srv_brows,v_room_2),(v_org_id,v_srv_lashes,v_room_2),
